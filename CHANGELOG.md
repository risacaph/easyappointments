# Mariners Appointment - Changelog
...
- Implementation of additional GDPR features in Mariners Appointment (#535)
...
- #664: Mariners Appointment v1.3.2 allows sensitive information disclosure (username and password hash).
...
- #176: Add Docker container for Mariners Appointment development.
...
- #21: Fix Mariners Appointment installation problems with AJAX requests.
- #66: Trouble with breaks for providers.

## [1.0.0] - 2014-01-19 

First Mariners Appointment release ever! ☺
