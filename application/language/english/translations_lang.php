...
$lang['about_app'] = 'About Mariners Appointment';
...
$lang['about_app_info'] = 'Mariners Appointment is a highly customizable web application that allows your customers to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using Mariners Appointment you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'Mariners Appointment is licensed under the GPLv3 license. By using the code of Mariners Appointment in any way you are agreeing to the terms described in the following url:';
...
$lang['ea_update_success'] = 'Mariners Appointment has been successfully updated.';
...
$lang['appointment_reminders'] = 'Appointment Reminders';
$lang['appointment_reminders_hint'] = 'When enabled, customers and providers receive a reminder email before their upcoming appointments. Requires the "console reminders" command to run periodically (e.g. via a cronjob).';
$lang['appointment_reminder_hours'] = 'Reminder Time Window (Hours)';
$lang['appointment_reminder_hours_hint'] = 'How many hours before the appointment start the reminder email should be sent.';
$lang['appointment_reminder_title'] = 'Appointment Reminder';
$lang['appointment_reminder_message'] = 'This is a friendly reminder for your upcoming appointment. Below you can see the appointment details. Make changes by clicking the appointment link.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the Mariners Appointment API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API enable you to interact with all the Mariners Appointment data via the HTTP protocol and the available API endpoints and create your own integrations.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'This integration enables you to connect to an existing LDAP server and automatically import users into Mariners Appointment and let them SSO with their directory password (username must match).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
