...
<head>
    ...
    <meta property="og:title" content="<?= lang('page_title') . ' ' . e(vars('company_name')) ?> | Mariners Appointment"/>
    ...
    <title><?= lang('page_title') . ' ' . e(vars('company_name')) ?> | Mariners Appointment</title>
