...
This guide explains how to set up a local CalDAV server (Baikal) for testing calendar sync with Mariners Appointment.
...
2. You'll see a setup form. Fill it in:
   - **Time zone:** Choose your local time zone (must match Mariners Appointment).
...
## Connecting Mariners Appointment to Baikal

1. In Mariners Appointment, go to the **Calendar** page.
